...
const InteractiveMenuPlate = ({
  ...
  const handleMouseMove = (e: ReactMouseEvent<HTMLDivElement>) => {
    ...
    const x = e.clientX - rect.left - rect.width / 2;
    const y = e.clientY - rect.top - rect.height / 2;
    // Calculate a subtle pull (2x stronger than gallery's 0.04)
    const pullX = x * 0.08;
    const pullY = y * 0.08;
    
    movingLayerRef.current.style.transform = `translate3d(${pullX}px, ${pullY}px, 0)`;
    movingLayerRef.current.style.transition = 'transform 0.1s ease-out';
  };

  const handleMouseLeave = () => {
    if (!movingLayerRef.current) return;
    movingLayerRef.current.style.transform = `translate3d(0px, 0px, 0)`;
    movingLayerRef.current.style.transition = 'transform 0.6s cubic-bezier(0.25, 1, 0.5, 1)';
  };
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-0 -translate-y-[15px] md:translate-y-0">
      ...
      >
        ...
        />
        <div ref={movingLayerRef} className="absolute inset-0 w-full h-full pointer-events-none z-20">
          {children}
        </div>
      </div>
    </div>
...
const GalleryCarousel = ({ images, id, title, initialIndex = 0 }: GalleryCarouselProps) => {
  ...
  const fontSize = useMemo(() => {
    if (!dimensions.width || !title) return 40;
    const targetW = dimensions.width * 0.88;
    try {
      const canvas = document.createElement('canvas');
      const ctx = canvas.getContext('2d');
      if (ctx) {
        ctx.font = '800 100px "Brygada 1918", serif';
      ...
      >
        ...
        {title && dimensions.width > 0 && dimensions.height > 0 && (
          ...
          >
            <defs>
              <mask id={`knockout-mask-${id}`}>
                ...
                <text
                  ...
                  fontWeight="800"
                  fontSize={fontSize}
                  textLength={Math.round(dimensions.width * 0.88)}
                  lengthAdjust="spacing"
                >
                  {title}
                </text>
              </mask>
              {/* Seamless unionized 1px outer outline filter in bordo (#571723) - avoids internal intersecting lines */}
              <filter id={`outline-filter-${id}`} x="-10%" y="-10%" width="120%" height="120%">
                <feMorphology in="SourceAlpha" result="DILATED" operator="dilate" radius="1" />
                <feComposite in="DILATED" in2="SourceAlpha" operator="out" result="OUTLINE" />
                <feFlood floodColor="#571723" floodOpacity="1" result="COLOR" />
            ...
            />
            {/* 1px crisp outer border around cutout letters in bordo (#571723) */}
            <text
              x={dimensions.width / 2}
              y={dimensions.height / 2}
              textAnchor="middle"
  ...
  return (
    <div className="bg-surface text-on-background font-body-md antialiased selection:bg-tertiary-container selection:text-on-tertiary-container overflow-x-hidden">
        ...
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop w-full">
          <div className="grid grid-cols-[1fr_auto_1fr] items-center w-full max-w-[1100px] mx-auto relative h-[80px]">
            ...
            <div className="flex items-center justify-end h-full">
              <div className="flex gap-2 items-center justify-end text-[#571723] font-['Brygada_1918'] font-semibold text-xl translate-y-[3px]">
      ...
      <section className="relative min-h-[calc(100dvh+50px)] md:min-h-screen flex items-center justify-center overflow-hidden bg-[#571723]" id="home">
        ...
        <div className="absolute bottom-[65px] md:bottom-[25px] left-0 w-full flex justify-center z-20 pointer-events-none translate-y-1/2">
          <button 
        ...
        <div className="relative z-10 max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop w-full flex-1 flex flex-col pt-12 md:pt-24 pb-16 md:pb-20 min-h-0">
          ...
          <div className="flex-1 w-full flex flex-col justify-center items-center min-h-0">
            <div className="grid grid-cols-1 lg:flex lg:flex-row lg:items-center lg:justify-center lg:gap-12 w-full max-w-[1140px] mx-auto h-full min-h-0">
              ...
              <div className="flex flex-col items-center justify-between text-center md:h-[380px] py-0 md:py-1 w-full h-full min-h-0 shrink lg:w-[340px] lg:flex-none">
              <div className="flex items-center justify-center w-full relative">
                <button 
                  onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} 
                  className="bg-transparent border-none p-0 outline-none m-0 shadow-none cursor-pointer focus:outline-none appearance-none tap-highlight-transparent relative flex items-center justify-center w-[180px] md:w-[340px] md:h-[322px] overflow-visible mx-auto hover:opacity-90 transition-opacity"
                  style={{ WebkitTapHighlightColor: 'transparent' }}
                  aria-label={t.back_to_top}
                >
                  <img alt="NOLA Logo" className="w-[180px] md:w-[509px] md:h-[360px] md:max-w-none h-auto object-contain block filter-beige shrink-0" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBjUqukmy_diKG__Y2yTmRzoO41sHZOjMIshtBpntnhu08tGJEZpahC_h9dsGlp9cgrKtkSsILhUrrOfYT66gdYod3LauexIURBkB7MyXbEF3EbldL-KTE56rGl90aeOKZQ_KzYGenTHnZdnKs36-uNiADc-2mdRE-wYDSSmqmHOjGG3PM7hJoVsBHfcSUXjo6nK28u4g4pltTU8GmScEPte7gzTN-tUPcx_k1yF9gXx6Fgmv9JJE2tM-szYu4-wbJ2trVSfPHyi7o" />
                </button>
              </div>
              <div className="text-[#e9e0da] font-body-md text-[11px] md:text-lg opacity-90 text-center w-[220px] md:w-full leading-tight md:leading-relaxed mt-0 md:mt-1 flex flex-col items-center justify-center shrink-0">
              ...
              <div className="flex flex-col items-center justify-center w-full">
                <div className="grid grid-cols-[auto_auto] gap-x-2.5 md:gap-x-4 mx-auto w-max text-[#e9e0da]">
                  ...
                  <div className="text-left font-body-md text-[11px] md:text-lg opacity-90 whitespace-nowrap leading-tight md:leading-[18px] pb-0.5 md:pb-2.5">
                    <div className="inline-grid grid-cols-[auto_auto_auto] items-center gap-x-1 tabular-nums">
                      <span className="w-[32px] md:w-[46px] text-left">13:00</span>
                      <span className="text-center px-0.5">-</span>
                      <span className="w-[36px] md:w-[54px] text-right">23:00</span>
                    </div>
                  </div>
                  ...
                  <div className="text-left font-body-md text-[11px] md:text-lg opacity-90 whitespace-nowrap leading-tight md:leading-[18px] pb-0.5 md:pb-2.5">
                    <div className="inline-grid grid-cols-[auto_auto_auto] items-center gap-x-1 tabular-nums">
                      <span className="w-[32px] md:w-[46px] text-left">13:00</span>
                      <span className="text-center px-0.5">-</span>
                      <span className="w-[36px] md:w-[54px] text-right">00:00</span>
                    </div>
                  </div>
                  ...
                  <div className="text-left font-body-md text-[11px] md:text-lg opacity-90 whitespace-nowrap leading-tight md:leading-[18px] pb-0.5 md:pb-2.5">
                    <div className="inline-grid grid-cols-[auto_auto_auto] items-center gap-x-1 tabular-nums">
                      <span className="w-[32px] md:w-[46px] text-left">12:00</span>
                      <span className="text-center px-0.5">-</span>
                      <span className="w-[36px] md:w-[54px] text-right">00:00</span>
                    </div>
                  </div>
                  ...
                  <div className="text-left font-body-md text-[11px] md:text-lg opacity-90 whitespace-nowrap leading-tight md:leading-[18px] pb-0">
                    <div className="inline-grid grid-cols-[auto_auto_auto] items-center gap-x-1 tabular-nums">
                      <span className="w-[32px] md:w-[46px] text-left">12:00</span>
                      <span className="text-center px-0.5">-</span>
                      <span className="w-[36px] md:w-[54px] text-right">22:00</span>
                    </div>
                  </div>
                </div>
...
export default function App() {
  ...
  return (
    <LanguageContext.Provider value={{lang, setLang}}>
      {/* Pasek poziomy na środku strony od lewej do prawej, 40px, niebieski z przezroczystością 50%, widoczny na samej górze podczas przewijania */}
      <div
        id="center-fixed-blue-bar"
        className="fixed top-1/2 left-0 right-0 w-full h-[40px] -translate-y-1/2 bg-[rgba(0,102,255,0.5)] z-[99999] pointer-events-none"
        aria-hidden="true"
      />
      {/* Pionowa kreska w połowie długości paska od samej góry do samego dołu strony, 5px, zielona 50% przezroczystości */}
      <div
        id="center-fixed-green-line"
        className="fixed top-0 bottom-0 left-1/2 -translate-x-1/2 w-[5px] h-full bg-[rgba(0,200,0,0.5)] z-[99999] pointer-events-none"
        aria-hidden="true"
      />
      <Routes>
